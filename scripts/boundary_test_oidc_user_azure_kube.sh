...
boundary connect kube -target-name azure_aks_target -target-scope-name project_azure -- get node --kubeconfig kubeconfig
#boundary connect kube -target-name azure_aks_target -target-scope-name project_azure -- exec --kubeconfig kubeconfig -n default bar -- /bin/sh 
#boundary connect kube -target-name azure_aks_target -target-scope-name project_azure -- exec --kubeconfig kubeconfig -- /bin/sh 
#boundary connect kube -target-name aks_target_29 -target-scope-name project_azure
